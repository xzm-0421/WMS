...
CREATE INDEX idx_pda_receive_session_status ON pda_receive_scan_session(status, update_time);
...
ALTER TABLE pda_inbound_record ADD source_type VARCHAR(30);
ALTER TABLE pda_inbound_record ADD source_bill_no VARCHAR(64);
ALTER TABLE pda_inbound_record ADD source_line_no INT;
ALTER TABLE pda_inbound_record ADD submit_batch_no VARCHAR(30);
