...
IF NOT EXISTS (SELECT 1 FROM pda_receive_submit_batch WHERE batch_no = 'RSB20260710100001')
BEGIN
    INSERT INTO pda_receive_submit_batch (
        ...
        'RSB20260710100001', 'PURCHASE_RECEIVE', 'INBOUND', 'CGSL240801721',
        'G1803', N'金蝶测试供应商',
        1, 61.0000,
        'PENDING', '1', N'测试员', 'PDA-TEST', GETDATE()
    );
END;

IF NOT EXISTS (SELECT 1 FROM pda_inbound_record WHERE record_no = 'RIN20260710100001')
BEGIN
