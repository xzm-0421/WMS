  ...
  <view class="page">
    ...
    <view v-if="detail" class="order-bar">
      <view class="order-info">
        ...
        <text v-if="detail.erpBillNo" class="order-erp">已审核 {{ detail.erpBillNo }}</text>
      </view>
      <view class="order-stat-wrap">
        <text class="order-stat">{{ checkedCount }}/{{ lines.length }} 已勾</text>
        <text v-if="partialCount" class="order-partial">部分已补 {{ partialCount }}</text>
      </view>
    </view>
      ...
      >
        <view class="row-header">
          ...
          <view class="row-main">
            <view class="name-row">
              ...
              <text v-if="isPartialLine(line)" class="partial-tag">部分已补</text>
            </view>
        ...
        <view class="qty-panel" @click.stop>
          ...
          <view v-if="!isDoneLine(line)" class="qty-edit">
            <text class="qty-edit-label">本次补料</text>
            <input
              class="qty-input"
              type="text"
              inputmode="decimal"
          ...
          <view v-else class="qty-done-tip">已全部补完</view>
        </view>
      </view>
    ...
    <view class="footer">
      <button
        ...
        @click="onSubmit"
      >
        确认补料{{ submitableCount ? ` (${submitableCount})` : '' }}
      </button>
    </view>
  </view>
</template>
...
import useProductionFeedScan from '@/composables/useProductionFeedScan.js'
